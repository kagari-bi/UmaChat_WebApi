...
但这样的问题在于，难以还原某些具有角色特色的表达内容（如美妙姿势的“ふふ”、“ごきげんよう”等）。一个可能的解决办法是让ChatGPT给出日文的答复，再调用翻译的接口翻译成中文，作为返回的文本。

但是百度翻译的结果在某些情况下还是会显得生涩，要吹毛求疵的话可能还是得用大型语言模型……正在尝试摸索更好的解决方法中。
